...
[Driver("SchneiderPLC")]
[DisplayName("施耐德PLC")]
public class SchneiderDriver : DisposeBase, IDriver, ILogFeature, ITracerFeature
{
    ...
    /// </summary>
    /// <returns></returns>
    public virtual IDriverParameter CreateParameter() => new SchneiderParameter
    {
    ...
    {
        var pm = JsonHelper.Convert<SchneiderParameter>(parameters);
